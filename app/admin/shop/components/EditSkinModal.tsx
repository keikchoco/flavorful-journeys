      ...
      >
        ...
        {selectedSkin.name && (
          <p className="text-sm text-gray-600 mb-3">
            Document name: <code className="bg-gray-100 px-1 rounded">{generateDocumentName(selectedSkin.name)}</code>
          </p>
        )}
        ...
        <div className="mb-4">
          ...
          {imageUploadMode === 'url' ? (
            <input
              ...
              onChange={(e) => setSelectedSkin({ ...selectedSkin, imageUrl: e.target.value })}
